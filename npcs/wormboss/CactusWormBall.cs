...
namespace gracosmod123.NPCs.wormboss
{
    public class CactusWormBall : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Spikey jade ball");
        }
        ...
        public override void PostDraw(SpriteBatch sb, Color lightColor)
        {
            ...
            sb.Draw(tex, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), new Rectangle?(new Rectangle(0, 0, tex.Width, tex.Height)), Color.White, projectile.rotation, new Vector2(tex.Width / 2, tex.Height / 2), projectile.scale, SpriteEffects.None, 0f);
        }
