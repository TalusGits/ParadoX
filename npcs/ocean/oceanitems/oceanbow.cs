...
{
    public class oceanbow : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Aquatic Bow");
            Tooltip.SetDefault("50 percent chance not to consume ammo changes wooden arrows to Awesomeness");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                type = ModContent.ProjectileType("starfish3"); // or ProjectileID.FireArrow;
            }
