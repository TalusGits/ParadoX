...
{
    public class eliasBow : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("mech Bow");
            Tooltip.SetDefault("50 percent chance not to consume ammo changes wooden arrows to high velocity bullets like a bow Uzi");
        }
