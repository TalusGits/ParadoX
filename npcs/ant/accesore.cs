...
namespace gracosmod123.NPCs.ant
{
    ...
    public class accesore : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Broken anatennae");
            Tooltip.SetDefault("the antenae that broke off the mask. if your health is 100 than increased regen and inferno");
        }
...
namespace gr.Items.Accessories
{
    public class eliasMeleeAccessory : ModItem
    {
