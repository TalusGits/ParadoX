...
{
    public class Crimstabby : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int count = 0; count < 10; count++)
            {
                ...
                Projectile.NewProjectileDirect((int)spawn.X, (int)spawn.Y, 0.0f, 0.0f, 304/*ID*/, projectile.damage, projectile.knockBack, 0, (float)projectile.whoAmI, (float)count);
            }
        }
    }
}
