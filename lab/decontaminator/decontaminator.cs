...
namespace gracosmod123.lab.decontaminator
{
    public class decontaminator : ModTile
    {
        ...
        public override void SetDefaults()
        {
            ...
            mineResist = 1;
            drop = mod.ItemType("decontaminatoritem");
        }
        ...
        public override void HitWire(int i, int j)
        {
            if (Wiring.CheckMech(i, j, 60))
            {
                ...
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 0f);
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 20f);
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 0f);
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 20f);
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 0f);
                Projectile.NewProjectile(new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, mod.ProjectileType("decontaminatorproj"), 18, .5f, Main.myPlayer, 20f);
